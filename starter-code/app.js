...
// COMMENT: Arrow functions make constructor functions more efficient and easier to read. They also extend their 
// usefulness by allowing data to be shared more smoothly from parent components to their children.
...
// COMMENT: When joe.scope() is invoked on line 186 above, "this" refers to whatever student is defined at the point when the .scope() function was called.

// 2. What is "this" when joe.scopeArrow() is invoked?
// COMMENT: When joe.scopeArrow(); is invoked on line 191 above, "this" refers to the student instantiated by the method on the prototype because that is where the function is defined. 

// 3. Explain why "this" is different when an arrow function is used.
// COMMENT: For arrow functions "this" is defined based on where the function is defined; the point from which "this" inherits it's context. For standard functions, "this" is defined by where the function is called. 
